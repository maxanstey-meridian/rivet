...
public sealed class Define
{
    ...
    // GET
    public static RouteDefinition<TInput, TOutput> Get<TInput, TOutput>(string route) =>
        new("GET", route);
    ...
    // PUT
    public static RouteDefinition<TInput, TOutput> Put<TInput, TOutput>(string route) =>
        new("PUT", route);
    ...
    // PATCH
    public static RouteDefinition<TInput, TOutput> Patch<TInput, TOutput>(string route) =>
        new("PATCH", route);
    ...
    public static RouteDefinition<TInput, TOutput> Delete<TInput, TOutput>(string route) =>
        new("DELETE", route);
