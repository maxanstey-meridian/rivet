...
public static class MembersContract
{
    ...
    public const string MinimalRoutePrefix = "/minimal";
    public const string AvatarRoute = "/api/members/{id:guid}/avatar";

    /// TS: list(): Promise<PagedResult<MemberDto>>
    public static readonly RouteDefinition<PagedResult<MemberDto>> List = Define
        .Get<PagedResult<MemberDto>>(ListRoute)
    ...
    public static readonly RouteDefinition<InviteMemberRequest, InviteMemberResponse> Invite =
        Define
            .Post<InviteMemberRequest, InviteMemberResponse>(InviteRoute)
    ...
    public static readonly InputRouteDefinition<RemoveMemberInput> Remove = Define
        .Delete(RemoveRoute)
    ...
    public static readonly InputRouteDefinition<UpdateRoleInput> UpdateRole = Define
        .Put(UpdateRoleRoute)
    ...
    public static readonly RouteDefinition Health = Define
        .Get(HealthRoute)
        .Description("Health check")
        .Anonymous();

    /// TS: avatarUrl(id: string, token: string): string  — QueryAuth → URL builder for media players
    public static readonly FileRouteDefinition Avatar = Define
        .File(AvatarRoute)
