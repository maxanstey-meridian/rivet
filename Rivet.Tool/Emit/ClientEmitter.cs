...
{
    public static string Emit(IReadOnlyList<TsEndpointDefinition> endpoints, IReadOnlyList<TsTypeDefinition> types)
    {
        ...
        {
            sb.AppendLine();
            EmitEndpoint(sb, endpoint);
        }

        return sb.ToString();
    }

    private static void EmitEndpoint(StringBuilder sb, TsEndpointDefinition endpoint)
    {
