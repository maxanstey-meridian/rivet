...
public static class TypeEmitter
{
    ...
    /// <summary>
    /// Emits a barrel index.ts that re-exports from all group files.
    /// </summary>
    public static string EmitBarrel(IReadOnlyList<string> fileNames)
    {
        var sb = new StringBuilder();
        sb.AppendLine("// Generated by Rivet — do not edit");
        sb.AppendLine();
        ...
        {
            sb.AppendLine($"export * from \"./{fileName}.js\";");
        }
