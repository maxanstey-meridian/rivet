    ...
    public static RivetOptions? ParseArgs(string[] args)
    {
        ...
        if (fromContractPath is not null)
        {
            return new RivetOptions(
                ...
                DefaultSecurity: securitySchemes.FirstOrDefault(),
                SecuritySchemes: securitySchemes,
                Quiet: quiet,
                FromContractPath: fromContractPath,
                Title: title,
                Version: version,
                Servers: servers,
                Verify: verify
        ...
        if (fromOpenApiPath is not null)
        {
            ...
            return new RivetOptions(
                ...
                files.ToArray(),
                openApiPath,
                securitySchemes.FirstOrDefault(),
                FromOpenApiPath: fromOpenApiPath,
