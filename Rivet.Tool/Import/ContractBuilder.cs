...
/// <summary>
/// Maps OpenAPI paths to contract intermediates grouped by tag.
/// </summary>
internal static class ContractBuilder
{
        ...
        List<string> warnings)
    {
        ...
        // Find lowest 2xx response with JSON content
    ...
    {
        // Common patterns: "tasks_getTask", "Tasks_GetTask", "tasks-getTask"
        var prefixes = new[]
        {
